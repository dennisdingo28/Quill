...
const UploadDropzone = () =>{
    ...
    return (
        <Dropzone multiple={false} onDrop={async (acceptedFile) => {
            ...
            if(!res || res.length<0 || res===undefined || !res[0].key){
                toast({
                    ...
                    <div className="flex items-center justify-center h-full w-full">
                        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                            ...
                            {acceptedFiles && acceptedFiles.length>0 && acceptedFiles[0] ? (
                                <div className="max-w-x bg-white flex items-center rounded-md overflow-hidden outline outline-[1px] outline-zinc-200 divide-x divide-zinc-200">
                                    <div className="px-3 py-2 h-full grid grid-place-items-center">
